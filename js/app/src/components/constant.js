...
export const TEAM_CARDS = 'Team Cards'
export const PLAYER_CARDS_ = 'Player Cards'
export const LEAGUES = ['ENG.1', 'ENG.2', 'SPA.1', 'ITA.1', 'GER.1', 'FRA.1']